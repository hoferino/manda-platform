...
All blockers resolved before Epic 2 sprint:

| Item | Status | Files |
|------|--------|-------|
| Vertex AI package | ✅ Installed | `package.json`, `.env.example` |
| Specialist stubs | ✅ Created | `lib/agent/v2/tools/specialist-definitions.ts` |
| Route consolidation | ✅ Complete | `/chat` is now v2 (sole entry point) |
