...
| E11: Agent Context Engineering | ✅ Complete | Context engineering, Pydantic AI |
| E12: Production Readiness | In Progress | E2E testing, error handling, LangSmith observability |
| E13: Agent Orchestration Optimization | Planned | Enhanced intent classification, workflow optimization |
...
│   │   ├── embeddings/           # Voyage AI embedding client (E10.8)
...
| Embeddings | Voyage AI | 0.3.0 | voyage-3.5 (1024d) - E10.8 |
...
│  │  │ Parser   │  │ (Voyage) │  │ Analysis │  │Extraction│    │ │
│  │  └──────────┘  └──────────┘  └──────────┘  └──────────┘    │ │
│  └─────────────────────────────────────────────────────────────┘ │
└─────────────────────────────────────────────────────────────────┘
```
...
- **Hybrid Search** for semantic + BM25 + graph traversal (Graphiti + Neo4j)
...
- `VOYAGE_API_KEY` - For Voyage embeddings (E10.8)
...
| Type | Location | Count |
|------|----------|-------|
| Epics | [docs/sprint-artifacts/epics/](sprint-artifacts/epics/) | 13 files |
| Tech Specs | [docs/sprint-artifacts/tech-specs/](sprint-artifacts/tech-specs/) | 10 files |
| Stories | [docs/sprint-artifacts/stories/](sprint-artifacts/stories/) | 100+ files |
| Retrospectives | [docs/sprint-artifacts/retrospectives/](sprint-artifacts/retrospectives/) | 11 files |
...
*This index was generated by the BMAD Document Project workflow. Last major update: 2026-01-06 (repository cleanup)*
