...
async def run_test():
    ...
    try:
        ...
        # -> Enter invalid username and password and click Sign In button.
        ...
        try:
            ...
            raise AssertionError('Test case failed: Login attempt with invalid credentials did not fail as expected, or the appropriate error message about invalid credentials was not displayed.')
